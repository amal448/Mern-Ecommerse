...
// import loginIcons from '../assest/signin.gif'; // Make sure the path to the gif is correct
...
const Login = () => {
  ...
  const handleSubmit=async(e)=>{
    ...
    console.log(form)
    try{
        const res= await axios.post("http://localhost:3000/api/user/signin",form, { withCredentials: true })
        console.log(res)
        ...
        {/* <h1 className="my-6">
          ...
          >
            ...
            />
                     ...
                     <h1 className="text-black text-4xl font-bold mb-10 uppercase"> Sign In</h1>
        ...
        <form onSubmit={handleSubmit} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
          <div className="pb-2 pt-4">
            <input
              ...
              name='email'
              placeholder="Email"
              className="block w-full p-4 text-lg rounded-sm bg-slate-200 outline-none"
              onChange={handleChange}
            />
          </div>
          <div className="pb-2 pt-4">
            <input
              className="block w-full p-4 text-lg rounded-sm bg-slate-200 text-black outline-none"
              type="password"
          ...
          <div class="">
                          <button  class="mt-4 mb-3 w-full bg-blue-500 hover:bg-green-400 text-white py-2 rounded-md transition duration-100 uppercase font-semibold">Login now</button>
